...
class SiteRouteTests(unittest.TestCase):
    ...
    def test_shared_assets_and_route_restoration_hooks(self):
        ...
        self.assertIn('src="/assets/openband.js?v=20260903b"', profile)
        ...
        contact_markup = javascript[javascript.index("function contactCardMarkup"):javascript.index("function updateHeaderContact")]
        self.assertNotIn("Website", contact_markup)
    ...
    def test_browse_page_uses_official_interactive_map_data(self):
        ...
        self.assertIn("clearReserveLandLayer();if(!band)return", javascript)
        self.assertIn("dataset.reserveParcelCount='0'", javascript)
        ...
        self.assertIn("directoryTouchBandId===bandId", javascript)
        self.assertIn("bubblingMouseEvents:false", javascript)
        self.assertIn("marker.openTooltip()", javascript)
        self.assertIn("tap a dot once to reveal its lands and tap it again", markup)
        ...
        self.assertNotIn("822 parcels", javascript)
