...
def build() -> None:
    ...
    for band in bands:
        ...
        page = page.replace(
            '<script src="/assets/openband.js?v=20260813d" defer></script>',
            f'<script>window.OPENBAND_BOOT={{"page":"profile","bandId":"{band["id"]}","slug":"{slug}"}};</script><script src="/assets/openband.js?v=20260813d" defer></script>',
            1,
        )
