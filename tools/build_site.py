...
def provincial_landing(base: str, code: str, name: str) -> str:
    ...
    page = page.replace(
        '<script src="/assets/openband.js?v=20260912c" defer></script>',
        f'<script>window.OPENBAND_BOOT={{"page":"province","province":"{code}"}};</script><script src="/assets/openband.js?v=20260912c" defer></script>',
        1,
    )
    return page
...
def build() -> None:
    ...
    for band in bands:
        ...
        page = page.replace(
            '<script src="/assets/openband.js?v=20260912c" defer></script>',
            f'<script>window.OPENBAND_BOOT={{"page":"profile","bandId":"{band["id"]}","slug":"{slug}"}};</script><script src="/assets/openband.js?v=20260912c" defer></script>',
            1,
        )
